# Maake sure to go to edit this one to be called instead of twitch manager in call all bots
...
class AzureBotTwitchManager:
        ...
        while loading:
            ...
            for line in readbuffer_join.split("\n")[0:-1]:
                if "End of /NAMES list" in line:
                    ...
                    self.send_message("T0MKETCHUM 's bot is now active!")
                    loading = False
    ...
    def check_file(self):
        ...
        while True:
            ...
            if os.path.exists(file_path):
                ...
                obswebsockets_manager.set_source_visibility("In Game", "pick a name", True)
                if current_mod_time > last_mod_time:  # Explicitly use last_mod_time in the comparison
                    ...
                    os.remove(file_path)
                    obswebsockets_manager.set_source_visibility("In Game", "pick a name", False)
    ...
    def twitch(self):
        ...
        allowed_words = ["Incomprehensibilities", "Supercalifragilisticexpialidocious", "<3", "the", "of", "a", "o",
                         "O", ".", "..", "...",]
        beta_call = ["Beta", "BETA", "beta", "beta...,", "Beta,", " beta", " Beta"]
